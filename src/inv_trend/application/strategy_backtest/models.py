"""Versioned contracts for the independent strategy-backtest stage."""
...
class BacktestPlan:
    ...
    def from_mapping(cls, raw: Mapping[str, Any]) -> "BacktestPlan":
        allowed = {
            ...
            "validation", "ranking", "strategy_config_path",
        }
...
__all__ = [
    ...
    "RankingPolicy", "SCHEMA_VERSION", "SourceInstrument", "ValidationPolicy",
    "canonical_hash",
]
