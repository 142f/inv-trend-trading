...
from inv_trend.adapters.detector.eligibility import (
    BlockedReason,
    BreakoutQuality,
    EligibilityStatus,
    MarketRegime,
...
from inv_trend.adapters.detector.eligibility.checker import AccountSnapshot
from inv_trend.adapters.detector.eligibility.thresholds import (
