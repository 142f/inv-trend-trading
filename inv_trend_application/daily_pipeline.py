...
deliberately left to ``inv_trend_observability`` at the CLI boundary.
"""
...
from historical_data import HistoricalDataService, create_default_providers
from inv_trend_core.signals import CORRECTED_STRATEGY_VERSION, SignalEvent

from turtle_detector.alerts.daily_notifier import LogNotifier, SignalNotifier
from turtle_detector.freshness import FreshnessPolicy
from turtle_detector.indicators.daily_signals import (
    analyze_prepared_daily_signals,
    prepare_daily_signal_frame,
)
from turtle_detector.models import AssetConfig
