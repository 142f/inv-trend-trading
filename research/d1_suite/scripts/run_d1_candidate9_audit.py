...
from research.d1_suite.scripts.d1_backtest_common import (
    CORE_SYMBOLS,
    EQUITY_SYMBOLS,
    build_run_specs as build_shared_run_specs,
    drawdown_window,
    load_universe,
    run_backtest,
    rules_3x,
...
def run_experiment(
    ...
    result, data, specs, _ = run_backtest(
        all_data=all_data,
        symbols=symbols,
        ...
        eth_mode=eth_mode,
        cost_multiplier=cost_multiplier,
        rules=build_rules(symbols, cluster_leverage, rule_overrides),
    )
